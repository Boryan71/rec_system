...
1. **Определять тип пользователя**  
	Классификация пользователей на активных и новичков на основе среднего рейтинга, активности и количества оцененных книг.
...
* **Возможность автоматического переобучения или использование имеющихся метаданных** — два режиме работы позволяют 
